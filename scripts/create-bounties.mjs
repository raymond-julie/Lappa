...
const issues = [
  ...
  { title: '[100 MRG] Foxglove / rosbridge desktop diagnostics panel', labels: ['bounty', 'bounty: feature', 'ide', 'docker', 'reward:100-mrg'],
    body: `## 100 MRG\n\nOptional Qt desktop panel connecting to rosbridge when Docker runtime is up.\n\n## Acceptance\n- [ ] Offline message if bridge down\n${footer}` },
  ...
  { title: '[100 MRG] Windows desktop installer polish', labels: ['bounty', 'bounty: feature', 'ide', 'release', 'reward:100-mrg'],
    body: `## 100 MRG\n\nPackage the PySide desktop IDE with branded icon metadata and reproducible Windows release steps.\n\n## Acceptance\n- [ ] README build steps Windows\n${footer}` },
